...
// machine warmup: stabilize runtime environment
  // branch predictor warming, page faults ...
  // global
// experiment state reset: before each experiment
  // reset to initial known state
